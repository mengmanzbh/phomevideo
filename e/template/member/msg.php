    ...
    if (e.name != 'chkall')
       e.checked = form.chkall.checked;
        ...
        <table class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
            <tr>
              <td>&nbsp;</td>
              <td><div align="right">[<a href="AddMsg/?enews=AddMsg">发送消息</a>]&nbsp;&nbsp;</div></td>
            </tr>
        </table>
        <br>
        <table class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <form name="listmsg" method="post" class="am-form" action="../doaction.php" onsubmit="return confirm('确认要删除?');">
            <tr class="header"> 
              <td> <div align="center"></div></td>
              <td><div align="center">标题</div></td>
              <td><div align="center">发送者</div></td>
              <td><div align="center">发送时间</div></td>
            ...
            <tr> 
              ...
              <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td><div align="center"><img src="../../data/images/<?=$img?>.gif" border=0></div></td>
                    <td><a href="ViewMsg/?mid=<?=$r[mid]?>"> 
