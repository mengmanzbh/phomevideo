      ...
      <table class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <form name="form1" method="post" class="am-form" action="">
            <tr> 
              ...
              <td><div align="right">[<a href="FavaClass/">管理分类</a>]&nbsp;&nbsp;</div></td>
            </tr>
          </form>
</table>
        <br>
        <table class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
          <form name=favaform method=post class="am-form" action="../doaction.php" onsubmit="return confirm('确认要操作?');">
            <input type=hidden value=DelFava_All name=enews>
            <tr class="header"> 
              <td><div align="center"></div></td>
              <td><div align="center">标题</div></td>
              <td><div align="center">点击</div></td>
              <td><div align="center">收藏时间</div></td>
